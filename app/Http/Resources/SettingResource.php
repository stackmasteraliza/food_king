...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'vat_number'                         => $this->info['vat_number'],
            ...
            'theme_logo'                           => $this->themeImage('theme_logo') ? $this->themeImage('theme_logo')->logo : asset('images/theme/theme-logo.png'),
            'theme_footer_logo'                    => $this->themeImage('theme_footer_logo') ? $this->themeImage('theme_footer_logo')->footerLogo : asset('images/theme/theme-footer-logo.png'),
            'theme_favicon_logo'                   => $this->themeImage('theme_favicon_logo') ? $this->themeImage('theme_favicon_logo')->faviconLogo : asset('images/theme/theme-favicon-logo.png'),
            ...
            'image_order_not_found'                => asset('/images/order/order-not-found.png'),
