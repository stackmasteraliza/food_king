...
import AdminIntegrationsComponent from "../../components/admin/settings/integrations/AdminIntegrationsComponent";
import AdminIntegrationsListComponent from "../../components/admin/settings/integrations/AdminIntegrationsListComponent";
...
import KitchenPrinterSettingListComponent from "../../components/admin/settings/KitchenPrinterSetting/KitchenPrinterSettingListComponent";
import KitchenPrinterSettingComponent from "../../components/admin/settings/KitchenPrinterSetting/KitchenPrinterSettingComponent";
import ShiftListComponent from "../../components/admin/settings/Shift/ShiftListComponent";
import ShiftComponent from "../../components/admin/settings/Shift/ShiftComponent";
import PosDeviceListComponent from "../../components/admin/settings/PosDevice/PosDeviceListComponent";
import PosDeviceComponent from "../../components/admin/settings/PosDevice/PosDeviceComponent";
...
export default [
    {
        ...
        children: [
            ...
            },
            {
                ...
                redirect: { name: "admin.settings.integrations.list" },
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
                ...
                children: [
                    {
                        path: "list",
                        component: AdminIntegrationsListComponent,
                        name: "admin.settings.integrations.list",
                        meta: {
                            isFrontend: false,
                            auth: true,
                            permissionUrl: "settings",
            ...
            {
                path: "KitchenPrinterSettings",
                component: KitchenPrinterSettingComponent,
                name: "admin.settings.KitchenPrinterSetting",
                redirect: { name: "admin.settings.KitchenPrinterSetting.list" },
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
                    breadcrumb: "KitchenPrinterSettings",
                },
                children: [
                    {
                        path: "list",
                        component: KitchenPrinterSettingListComponent,
                        name: "admin.settings.KitchenPrinterSetting.list",
                        meta: {
                            isFrontend: false,
                            auth: true,
                            permissionUrl: "settings",
            ...
            },
            {
                ...
                name: "admin.settings.Shift",
                redirect: { name: "admin.settings.Shift.list" },
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
                ...
                children: [
                    {
                        ...
                        name: "admin.settings.Shift.list",
                        meta: {
                            isFrontend: false,
                            auth: true,
                            permissionUrl: "settings",
            ...
            },
            {
                ...
                name: "admin.settings.PosDevice",
                redirect: { name: "admin.settings.PosDevice.list" },
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
                    breadcrumb: "posdevices",
                },
                children: [
                    {
                        path: "list",
                        component: PosDeviceListComponent,
                        name: "admin.settings.PosDevice.list",
                        meta: {
                            isFrontend: false,
                            auth: true,
                            permissionUrl: "settings",
