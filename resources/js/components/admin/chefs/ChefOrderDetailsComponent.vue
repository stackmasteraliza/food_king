<template>
    ...
    <OrderDetailsComponent :order="order" :orderItems="orderItems" :orderBranch="orderBranch"
        :orderAddress="orderAddress" :order_Reservations="order_Reservations" />
</template>
<script>
...
export default {
    name: "ChefOrderDetailsComponent",
    ...
    computed: {
        ...
        orderAddress: function () {
          ...
          order_Reservations: function () {
            return this.$store.getters['myOrderDetails/order_Reservations'];
        },
    },
    mounted() {
