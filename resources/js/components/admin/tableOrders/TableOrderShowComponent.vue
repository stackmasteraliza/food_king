<template>
    ...
    <div class="db-card p-4">
      <div class="flex flex-wrap gap-y-5 items-end justify-between">
        ...
        >
          ...
          <button
            type="button"
            @click="changeStatus(enums.orderStatusEnum.ACCEPT)"
        ...
        <div
          class="flex flex-wrap gap-3"
          v-else-if="
            order.status !== enums.orderStatusEnum.REJECTED &&
  ...
  <div class="col-12 sm:col-6">
    <div class="row">
      ...
      <div
        class="col-12"
        v-if="order.status === enums.orderStatusEnum.REJECTED"
      >
        <div class="db-card">
          <div class="db-card-header">
