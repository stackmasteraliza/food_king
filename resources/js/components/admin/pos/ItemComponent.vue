<template>
  ...
  >
    ...
    >
      <img
        class="pos-image-height w-full rounded-t-2xl"
        :src="item.thumb"
        alt="item"
      ...
      <div class="py-3 px-3 rounded-b-2xl">
        ...
        <div class="flex items-center justify-between gap-2">
          <h4 style="font-family: 'saudi_riyal'" class="font-rubik">
            {{
              item.offer.length > 0
        ...
        <div class="mb-4" v-if="item.itemAttributes.length > 1">
          <div class="row">
            ...
            >
              ...
              <div class="relative">
                <i
                  class="lab lab-arrow-down text-sm absolute top-1/2 right-2.5 -translate-y-1/2 lab-font-size-16"
                ></i>
                <select
                  @change.prevent="
              ...
              <SwiperSlide v-for="addon in item.addons" :key="addon">
                <div class="!w-fit !relative">
                  ...
                  >
                    ...
                    />
                    <div
                      class="ltr:rounded-r-lg rtl:rounded-l-lg w-full py-1 px-2"
                    >
                      <span
...
export default {
  ...
  methods: {
    ...
    variationModalShow: function (selectedItem) {
      this.$store
        .dispatch("item/details", selectedItem.id)
        .then((res) => {
    ...
    addToCart: function () {
      ...
      if (this.itemArrays.length > 0) {
        this.$store
          .dispatch("posCart/lists", this.itemArrays)
          .then((res) => {
            this.item = null;
            this.temp.name = "";
            this.temp.image = "";
