      ...
      <form @submit.prevent="save">
        <div class="form-row">
          <div class="form-col-12 sm:form-col-6">
            ...
            />
            <small class="db-field-alert" v-if="errors.company_name">{{
              errors.company_name[0]
            }}</small>
          </div>
          <div class="form-col-12 sm:form-col-6">
            <label for="vat_number" class="db-field-title required">
              {{ $t("الرقم الضريبي") }}
            </label>
            <input
              v-model="form.vat_number"
              v-bind:class="errors.vat_number ? 'invalid' : ''"
              type="text"
              id="vat_number"
              class="db-field-control"
            />
            <small class="db-field-alert" v-if="errors.vat_number">{{
              errors.vat_number[0]
            }}</small>
          </div>
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              class="db-field-control"
            />
            <small class="db-field-alert" v-if="errors.company_email">{{
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              v-bind:class="errors.company_phone ? 'invalid' : ''"
              type="text"
              id="phone"
              class="db-field-control"
            />
            <small class="db-field-alert" v-if="errors.company_phone">{{
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              v-bind:class="errors.company_website ? 'invalid' : ''"
              type="text"
              id="website"
              class="db-field-control"
            />
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              class="db-field-control"
            />
            <small class="db-field-alert" v-if="errors.company_city">{{
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              class="db-field-control"
            />
            <small class="db-field-alert" v-if="errors.company_state">{{
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <vue-select
              ...
              label-by="country_name"
              value-by="country_code"
              :closeOnSelect="true"
              :searchable="true"
              :clearOnClose="true"
              placeholder="--"
          ...
          <div class="form-col-12 sm:form-col-6">
            ...
            <input
              ...
              v-bind:class="errors.company_zip_code ? 'invalid' : ''"
              type="text"
              id="company_zip_code"
              class="db-field-control"
            />
          ...
          <div class="form-col-12">
            ...
            <textarea
              ...
              v-bind:class="errors.company_address ? 'invalid' : ''"
              id="address"
              class="db-field-control"
            >
            </textarea>
