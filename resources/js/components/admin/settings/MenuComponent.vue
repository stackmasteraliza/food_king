<template>
  ...
  <div
    class="h-0 overflow-hidden md:h-auto md:overflow-auto transition-all duration-300"
  >
    <nav class="db-card p-3">
      ...
      <router-link
        :to="{ name: 'admin.settings.kioskMachines' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.orderSetup' }"
        class="db-tab-btn"
      >
        <i class="lab lab-order-setup text-sm"></i>
        {{ $t("menu.order_setup") }}
      </router-link>
      <router-link :to="{ name: 'admin.settings.Shift' }" class="db-tab-btn">
        <i class="lab lab-order-setup text-sm"></i>
        {{ $t("menu.shifts") }}
      </router-link>
      <router-link
        :to="{ name: 'admin.settings.PosDevice' }"
        class="db-tab-btn"
      >
        <i class="lab lab-order-setup text-sm"></i>
        {{ $t("menu.PosDevices") }}
      ...
      <router-link
        :to="{ name: 'admin.settings.notification' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.notificationAlert' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.KitchenPrinterSetting' }"
        class="db-tab-btn"
      >
        <i class="lab lab-currencies text-sm"></i>
        {{ $t("menu.KitchenPrinterSettings") }}
      </router-link>
      <router-link
        :to="{ name: 'admin.settings.socialMedia' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.integrations' }"
        class="db-tab-btn"
      >
        <i class="lab lab-currencies text-sm"></i>
        {{ $t("menu.integrations") }}
      ...
      <router-link
        :to="{ name: 'admin.settings.itemCategory' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.itemAttribute' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.smsGateway' }"
        class="db-tab-btn"
      >
      ...
      <router-link
        :to="{ name: 'admin.settings.paymentGateway' }"
        class="db-tab-btn"
      >
