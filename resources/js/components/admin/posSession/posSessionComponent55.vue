      ...
      <div class="db-card">
        <div class="db-card-header border-none">
          ...
          <div class="db-card-filter">
            ...
            />
            <FilterComponent
              @click.prevent="handleSlide('transaction-filter')"
            />
            ...
            <div class="row">
              <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                <label
                  ...
                  >{{ $t("label.transaction_id") }}</label
                >
                <input
                  id="transaction_id"
                  v-model="props.search.transaction_no"
                  type="text"
...
export default {
  ...
  methods: {
    ...
    list: function (page = 1) {
      ...
      this.$store
        .dispatch("transaction/lists", this.props.search)
        .then((res) => {
    ...
    xls: function () {
      this.loading.isActive = true;
      this.$store
        .dispatch("transaction/export", this.props.search)
        .then((res) => {
          this.loading.isActive = false;
