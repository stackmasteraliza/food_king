    ...
    <div class="row">
        ...
        <div class="p-4 rounded-lg flex items-center gap-4 bg-[#FF4F99]">
          ...
          <div>
            ...
            <h4
              ...
              class="font-semibold text-[22px] leading-[34px] text-white"
            >
              {{ total_sales }}
              &#xE900;
            </h4>
      ...
      <div class="col-12 sm:col-6 xl:col-3">
        <div class="p-4 rounded-lg flex items-center gap-4 bg-[#8262FE]">
          ...
          >
            <i
              class="lab lab-total-orders lab-font-size-24 lab-color-portage"
            ></i>
          </div>
          <div>
            <h3 class="font-medium text-white">
      ...
      <div class="col-12 sm:col-6 xl:col-3">
        <div class="p-4 rounded-lg flex items-center gap-4 bg-[#567DFF]">
          ...
          >
            <i
              class="lab lab-total-customers lab-font-size-24 lab-color-cornflower-blue"
            ></i>
          </div>
          <div>
            <h3 class="font-medium text-white">
              {{ $t("label.total_customers") }}
            </h3>
            <h4 class="font-semibold text-[22px] leading-[34px] text-white">
              {{ total_customers }}
            </h4>
      ...
      <div class="col-12 sm:col-6 xl:col-3">
        <div class="p-4 rounded-lg flex items-center gap-4 bg-[#A953FF]">
          ...
          >
            <i
              class="lab lab-total-menu-items lab-font-size-24 lab-color-heliotrope"
            ></i>
          </div>
          <div>
            <h3 class="font-medium text-white">
...
export default {
  ...
  methods: {
    ...
    totalOrders: function () {
      this.loading.isActive = true;
      this.$store
        .dispatch("dashboard/totalOrders")
        .then((res) => {
    ...
    totalCustomers: function () {
      this.loading.isActive = true;
      this.$store
        .dispatch("dashboard/totalCustomers")
        .then((res) => {
    ...
    totalMenuItems: function () {
      this.loading.isActive = true;
      this.$store
        .dispatch("dashboard/totalMenuItems")
        .then((res) => {
