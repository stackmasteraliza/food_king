      ...
      <div class="row">
        <div class="col-12 md:col-7">
          <div class="mb-6 rounded-2xl shadow-xs bg-white">
            <h3 class="capitalize font-medium p-4 border-b border-gray-100">
              {{ $t("label.table") }}
            </h3>
            <p class="capitalize p-4 text-heading">
              {{ $t("label.inside") }} - {{ table.name }}
            </p>
          </div>
          ...
          <div class="mb-6 rounded-2xl shadow-xs bg-white">
            ...
            <ul class="p-4 flex flex-col gap-5">
              <li class="flex items-center gap-1.5">
                ...
                <label for="cash" class="db-field-label text-heading">{{
                  $t("label.cash_card")
                }}</label>
              </li>
              <li class="flex items-center gap-1.5">
                ...
                <label for="digital" class="db-field-label text-heading">{{
...
export default {
  ...
  methods: {
    ...
    orderSubmit: function () {
      ...
      this.checkoutProps.form.total = parseFloat(this.subtotal).toFixed(
