      ...
      <div class="flex items-start flex-col md:flex-row gap-6">
        <div class="w-full">
          <div class="p-4 mb-6 rounded-2xl shadow-xs bg-white">
            ...
            <div
              ...
              "
            >
              <h3 class="capitalize font-medium text-sm leading-6 mb-2">
                {{ $t("label.reason") }}:
              </h3>
          ...
          <div
            ...
            v-if="
              orderAddress && order.order_type === enums.orderTypeEnum.DELIVERY
            "
          >
          ...
          <div
            ...
            v-if="
              order_Reservations &&
              order.order_type === enums.orderTypeEnum.Reservations
            "
          >
            <h3 class="text-sm leading-6 font-medium mb-2">
              {{ $t("label.Reservations") }}
            </h3>
            <div class="flex items-start justify-start gap-2.5">
              <i
                class="lab lab-location leading-none mt-1.5 flex-shrink-0 lab-font-size-14"
              ...
              <span class="text-sm leading-6 text-heading">
                {{
                  $t("label.Reservations Date") +
                  ":" +
                  order_Reservations.ReservationsDate
                }}
              </span>
            </div>
            <div
              v-if="order.order_type === enums.orderTypeEnum.Reservations"
            ...
            >
              ...
              >
                {{
                  $t("label.Reservations Amount") +
                  ":" +
                  order_Reservations.ReservationsAmount
                }}
              </span>
            </div>
          </div>
          ...
          >
            ...
            <ul class="flex flex-col gap-2 mb-6">
              <li
                ...
                v-if="parseInt(order.source) === enums.sourceEnum.POS"
              >
                ...
                <span class="capitalize text-sm leading-6 text-heading">
                  ...
                  <span
                    v-if="
                      order.pos_payment_method !==
                        enums.posPaymentMethodEnum.CASH &&
                  ...
                  <span
                  v-if="
                    order.pos_payment_method === enums.posPaymentMethodEnum.CARD
                  "
                >
                  {{ $t("مبلغ النقد") }}
                  {{ order.pos_received_currency_amount }}
                  {{ $t("مبلغ الشبكه") }} {{ order.NetworkAmount }}
                </span>
                </span>
              </li>
              ...
              <li class="flex items-center gap-2">
                ...
                <span
                  ...
                  :class="
                    enums.paymentStatusEnum.PAID === order.payment_status
                      ? 'text-green-600'
                      : 'text-[#FB4E4E]'
                  "
                >
        ...
        <div class="w-full rounded-2xl shadow-xs bg-white">
          <div class="p-4 border-b">
            <h3 class="font-medium text-sm leading-6 capitalize mb-4">
              ...
              >
                <div class="flex items-center gap-3 relative">
                  ...
                  <div class="w-full">
                    ...
                    >
                      <span
                        v-for="variation in item.item_variations"
                        :key="variation"
                      >
                        <span
          ...
          <div
            class="p-4"
            v-if="order.status === enums.orderStatusEnum.PENDING"
          >
            <button
              @click="changeStatus(enums.orderStatusEnum.CANCELED)"
          ...
          <div class="p-4" v-else>
            <FrontendOrderReceiptComponent
              ...
              :order_Reservations="order_Reservations"
            />
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    order_Reservations: function () {
      return this.$store.getters["frontendOrder/order_Reservations"];
    },
  },
  mounted() {
