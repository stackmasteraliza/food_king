<template>
  ...
  >
    ...
    <span class="text-base font-medium capitalize text-white">
      {{ $t("button.print_invoice") }}</span
    >
  </button>
        ...
        >
          <table class="w-full">
            <tbody>
              <tr
                v-if="
                  parseInt(order.source) === enums.sourceEnum.POS &&
              ...
              >
                ...
                >
                  ...
                  <span
                    >{{ $t("label.change") }} :
                    {{ order.cash_back_currency_amount }}</span
                  >
                </td>
              </tr>
        ...
        >
          <table>
            <tbody>
              ...
              <tr v-if="order.order_type === enums.orderTypeEnum.Reservations">
